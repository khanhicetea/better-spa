/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.env.types` (hash: 4461ae7b68fa504055d2c0ed9a32550c)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/cloudflare-worker");
	}
